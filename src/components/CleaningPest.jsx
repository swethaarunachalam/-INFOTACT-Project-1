  ...
  const bookservice = [
    {
      ...
      image: "public/images/Cleaning Pest/FullHomeClean.jpeg",
    },
    {
      id: 2,
      title: "Cockroach, Ant & General pest control",
      image: "public/images/Cleaning Pest/cockroach ctrl.avif",
    },
    {
      id: 3,
      title: "Sofa & carpet cleaning",
      image: "public/images/Cleaning Pest/sofa.webp",
    },
    {
      id: 4,
      title: "Disinfection Services",
      image: "public/images/Cleaning Pest/disinfection.jpg",
    },
  ];
  ...
  return (
    <section className="py-5 position-relative bg-light">
      <div className="container">
        <h2 className="mb-4 fw-semibold">Cleaning & pest control</h2>
