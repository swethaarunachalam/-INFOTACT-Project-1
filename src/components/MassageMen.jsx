  ...
  const bookservice = [
    {
      id: 1,
      title: "Pain relief",
      image: "public/images/Massage Men/massage.webp",
    },
    {
      id: 2,
      title: "Stress relief",
      image: "public/images/Massage Men/stress.webp",
    },
    {
      id: 3,
      title: "Post Workout",
      image: "public/images/Massage Men/postworkout.jpg",
    },
  ...
  return (
    <section className="py-5 position-relative bg-light">
      <div className="container">
        <h2 className="mb-4 fw-semibold">Massage For Men</h2>
